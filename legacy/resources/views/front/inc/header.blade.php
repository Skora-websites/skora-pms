...
<div class="ul-sidebar">
    ...
    <div class="ul-sidebar-header">
        <div class="ul-sidebar-header-logo">
            <a href="{{ url('/') }}">
                <img src="{{ asset('front-assets/img/logo-new.png') }}" height="40" alt="skora cares logo"
                    class="logo">
            </a>
        </div>
        <!-- sidebar closer -->
...
<style>
    ...
    /* .ul-header-nav a.active {
     border-color: #198754;
    color: #f6f9f8;
    background-color: rgb(188 255 224 / 10%);
    font-weight: 600;
    padding: 8px 20px;
    border-radius: 40px;
        ...
        <div class="ul-header-bottom-wrapper ul-header-container">
            <div class="logo-container">
                <a href="{{ url('/') }}" class="d-inline-block">
                    <img src="{{ asset('front-assets/img/logo-new.png') }}" height="40" alt="logo" class="logo"
