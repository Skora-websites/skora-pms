...
<head>
    ...
    <title>Doctors | Doctors-Appointment-Details</title>
    ...
    <!-- Theme Config Js -->
    <script src="assets/js/theme-script.js" type="ee1f4dba178313e7100d3cbc-text/javascript"></script>
...
<body>
   ...
   @include('front.inc.header')
                ...
                <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2 pb-3 mb-3 border-1 border-bottom">
                    ...
                    <div class="text-end d-flex">
                        ...
                        <div class="bg-white border shadow-sm rounded px-1 pb-0 text-center d-flex align-items-center justify-content-center">
                            <a href="doctors-appointments.php" class="bg-white rounded p-1 d-flex align-items-center justify-content-center"> <i class="ti ti-list fs-14 text-dark"></i></a>
                            <a href="doctors-appointment-details.php" class="bg-light rounded p-1 d-flex align-items-center justify-content-center"> <i class="ti ti-calendar-event fs-14 text-body"></i> </a>
                        </div>
    ...
    <div class="modal fade" id="add_event">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="https://preclinic.dreamstechnologies.com/html/template/calendar.html">
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="ee1f4dba178313e7100d3cbc-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="ee1f4dba178313e7100d3cbc-text/javascript"></script>    

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="ee1f4dba178313e7100d3cbc-text/javascript"></script>

    <!-- Select2 JS -->
    <script src="assets/plugins/select2/js/select2.min.js" type="ee1f4dba178313e7100d3cbc-text/javascript"></script>

    <!-- Daterangepikcer JS -->
	<script src="assets/js/moment.min.js" type="ee1f4dba178313e7100d3cbc-text/javascript"></script>
	<script src="assets/plugins/daterangepicker/daterangepicker.js" type="ee1f4dba178313e7100d3cbc-text/javascript"></script>

    <!-- Fullcalendar JS -->
    <script src="assets/plugins/fullcalendar/index.global.min.js" type="ee1f4dba178313e7100d3cbc-text/javascript"></script>
    <script src="assets/plugins/fullcalendar/calendar-data.js" type="ee1f4dba178313e7100d3cbc-text/javascript"></script>

    <!-- Datetimepicker JS -->
    <script src="assets/js/moment.min.js" type="ee1f4dba178313e7100d3cbc-text/javascript"></script>
    <script src="assets/js/bootstrap-datetimepicker.min.js" type="ee1f4dba178313e7100d3cbc-text/javascript"></script> 

    <!-- Datatable JS -->
    <script src="assets/js/jquery.dataTables.min.js" type="ee1f4dba178313e7100d3cbc-text/javascript"></script>
    <script src="assets/js/dataTables.bootstrap5.min.js" type="ee1f4dba178313e7100d3cbc-text/javascript"></script>

    <!-- Custom JS -->
    <script src="assets/js/script.js" type="ee1f4dba178313e7100d3cbc-text/javascript"></script>

<script src="cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="ee1f4dba178313e7100d3cbc-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"960ff2569b69f04f","version":"2025.7.0","serverTiming":{"name":{"cfExtPri":true,"cfEdge":true,"cfOrigin":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}' crossorigin="anonymous"></script>
</body>
</html>