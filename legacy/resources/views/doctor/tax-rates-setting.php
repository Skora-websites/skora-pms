...
<head>
    ...
    <!-- Theme Config Js -->
    <script src="assets/js/theme-script.js" type="bfcf2ffecb3ef666ebd72ebe-text/javascript"></script>
...
<body>
        ...
        <div id="add_tax_rate" class="modal fade">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="https://preclinic.dreamstechnologies.com/html/template/tax-rates-settings.html">
                ...
                <div class="modal-content">
                    <div class="modal-body text-center position-relative">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <a href="tax-rates-settings.html" class="btn btn-danger position-relative z-1">Yes, Delete</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="bfcf2ffecb3ef666ebd72ebe-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="bfcf2ffecb3ef666ebd72ebe-text/javascript"></script>    

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="bfcf2ffecb3ef666ebd72ebe-text/javascript"></script>

    <!-- Bootstrap Tagsinput JS -->
    <script src="assets/plugins/bootstrap-tagsinput/bootstrap-tagsinput.js" type="bfcf2ffecb3ef666ebd72ebe-text/javascript"></script>

    <!-- Main JS -->
    <script src="assets/js/script.js" type="bfcf2ffecb3ef666ebd72ebe-text/javascript"></script>

<script src="cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="bfcf2ffecb3ef666ebd72ebe-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"960fec85f814f04f","version":"2025.7.0","serverTiming":{"name":{"cfExtPri":true,"cfEdge":true,"cfOrigin":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}' crossorigin="anonymous"></script>
</body>
</html>