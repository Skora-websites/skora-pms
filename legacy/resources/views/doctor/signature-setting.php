...
<head>
    ...
    <title>Doctors | Signatures Settings</title>
    ...
    <!-- Theme Config Js -->
    <script src="assets/js/theme-script.js" type="b8fe4d4ef40af108d4b82cd5-text/javascript"></script>
...
<body>
        ...
        <div id="add_reason" class="modal fade">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form action="https://preclinic.dreamstechnologies.com/html/template/signatures-settings.html">
                ...
                <div class="modal-content">
                    <div class="modal-body text-center position-relative">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <a href="signatures-settings.html" class="btn btn-danger position-relative z-1">Yes, Delete</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="b8fe4d4ef40af108d4b82cd5-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="b8fe4d4ef40af108d4b82cd5-text/javascript"></script>    

	<!-- Simplebar JS -->
	<script src="assets/plugins/simplebar/simplebar.min.js" type="b8fe4d4ef40af108d4b82cd5-text/javascript"></script>

    <!-- Select2 JS -->
    <script src="assets/plugins/select2/js/select2.min.js" type="b8fe4d4ef40af108d4b82cd5-text/javascript"></script>

    <!-- Daterangepikcer JS -->
    <script src="assets/js/moment.min.js" type="b8fe4d4ef40af108d4b82cd5-text/javascript"></script>
    <script src="assets/plugins/daterangepicker/daterangepicker.js" type="b8fe4d4ef40af108d4b82cd5-text/javascript"></script>

    <!-- Main JS -->
    <script src="assets/js/script.js" type="b8fe4d4ef40af108d4b82cd5-text/javascript"></script>

<script src="cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="b8fe4d4ef40af108d4b82cd5-|49" defer></script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"960fec792f6e51de","version":"2025.7.0","serverTiming":{"name":{"cfExtPri":true,"cfEdge":true,"cfOrigin":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"token":"3ca157e612a14eccbb30cf6db6691c29","b":1}' crossorigin="anonymous"></script>
</body>
</html>