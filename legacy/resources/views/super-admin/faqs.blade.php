...
<div class="faq-header d-flex flex-column justify-content-center align-items-center h-px-300 position-relative overflow-hidden rounded-3">
  <img src="../../assets/img/pages/header-light.png" class="scaleX-n1-rtl faq-banner-img h-px-300 z-n1" alt="background image" data-app-light-img="pages/header-light.png" data-app-dark-img="pages/header-dark.html" />
    ...
    <div class="d-flex justify-content-between flex-column nav-align-left mb-2 mb-md-0">
      ...
      <div class="d-none d-md-block">
        <div class="mt-5 text-center">
          <img src="../../assets/img/illustrations/illustration-john.png" class="img-fluid w-px-300" alt="FAQ Image">
        </div>
      </div>
    </div>
  </div>
