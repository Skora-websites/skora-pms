                                ...
                                <form id="smtpForm" method="POST" action="{{ route('mail.settings.update') }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="mail_host" name="mail_host" placeholder="smtp.gmail.com" value="{{ $settings->host ?? '' }}" required>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label for="mail_port" class="form-label">Mail Port</label>
                                            <input type="number" class="form-control" id="mail_port" name="mail_port" placeholder="587" value="{{ $settings->port ?? '' }}" required>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label for="mail_username" class="form-label">Mail Username (Email)</label>
                                            <input type="text" class="form-control" id="mail_username" name="mail_username" placeholder="example@gmail.com" value="{{ $settings->username ?? '' }}" required>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label for="mail_password" class="form-label">Mail Password (App Password)</label>
                                            <div class="input-group">
                                                <input type="password" class="form-control" id="mail_password" name="mail_password" minlength="8" value="{{ $settings->password ?? '' }}" required>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="from_name" name="from_name" placeholder="Your Website" value="{{ $settings->from_name ?? '' }}" required>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label for="from_email" class="form-label">From Email</label>
                                            <input type="email" class="form-control" id="from_email" name="from_email" placeholder="no-reply@yourdomain.com" value="{{ $settings->from_address ?? '' }}" required>
                                        </div>
                                    </div>
