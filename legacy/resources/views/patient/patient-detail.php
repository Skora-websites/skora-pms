    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="content">
                ...
                <!-- page header start -->
                <div class="mb-4">
                    <h6 class="fw-bold mb-0 d-flex align-items-center"> <a href="" class="text-dark"></i>Patient-detail</a></h6>
                </div>
                <!-- page header end -->
                                    ...
                                    <div class="col-sm-7">
                                        <div class="d-flex align-items-center mb-3">
                                            ...
                                            <div>
                                                ...
                                                <p class="mb-0 text-break"><a href="https://preclinic.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="3958555b5c4b4d56795c41585449555c175a5654">[email&#160;protected]</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="card-header border-bottom py-3  mb-3">
                    <div class="">
                        ...
                        <h5 class="mb-0 text-primary fw-semibold d-flex align-items-center">
                            ...
                            <span style="color: #172c75;">Prescription Document</span>
                        </h5>
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                                ...
                                <div class="accordion-item mt-3">
                                    <h2 class="accordion-header d-flex justify-content-center">
                                        <button class="accordion-button collapsed shadow btn btn-lg btn-outline-light py-3 px-4 fw-semibold border rounded-2 w-auto d-flex justify-content-between align-items-center gap-2 w-100"
                                            ...
                                            <span>View Latest Prescription</span>
                                        ...
                                        <div class="accordion-body">
                                            ...
                                            <div class="mb-2 d-flex justify-content-center">
                                                <div class="avatar avatar-xxxl">
                                                    <img src="assets/img/users/pres1.jpg"
                                                        alt="user"
                            ...
                            <div class="accordion-item mt-3">
                                ...
                                <div id="flush-collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">
                                        <div class="container border rounded-4 shadow p-4 my-4" style=" background-color: fff;">
                                            <!-- Doctor Info -->
                                            <div class="d-flex justify-content-between border-bottom pb-3 mb-3">
                                                <div>
                                                    <h4 class="fw-bold text-primary mb-0">Dr. Nikhil Mehra</h4>
                                                    <small class="text-muted">MD, Internal Medicine</small><br>
                                                    <small class="text-muted">Reg No: IN/987654</small>
                                                </div>
                                                <div class="text-end">
                                                    <p class="mb-0"><strong>Grace Healthcare</strong></p>
                                                    <small>45-B Wellness Street, Lucknow</small><br>
                                            ...
                                            <div class="row mb-4">
                                                <div class="col-md-6">
                                                    <strong>Patient:</strong> Aarti Kumari<br>
                                                    <strong>Age/Gender:</strong> 42 / Female
                                                </div>
                                                <div class="col-md-6 text-md-end">
                                                    <strong>Date:</strong> 25 July 2025<br>
                                                    <strong>Treatment ID:</strong> T1004
                                                </div>
                                            </div>

                                            <!-- Ongoing Treatment Section -->
                                            <div class="mb-4">
                                                <h5 class="text-dark fw-semibold border-bottom pb-2">Ongoing Treatment Summary</h5>
                                                <p><strong>Condition:</strong> Type 2 Diabetes Mellitus with Hypertension</p>
                                                <p><strong>Started On:</strong> 5 June 2025</p>

                                                <ul>
                                                    <li>Blood Sugar Monitoring (Fasting & PP)</li>
                                                    <li>BP Tracking (Morning & Evening)</li>
                                                    <li>Low-carb Diet + Daily 30 min Walk</li>
                                                    <li>Regular Intake of Metformin 500mg</li>
                                                </ul>
                                            </div>

                                            <!-- Medicines -->
                                            <div class="mb-4">
                                                <h5 class="fw-semibold text-dark border-bottom pb-2">Current Medications</h5>
                                                    ...
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>1 Tablet</td>
                                                                <td>After Breakfast & Dinner</td>
                                                                <td>Ongoing</td>
                                                                <td>Continue medication without break</td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>Every Morning</td>
                                                                <td>Ongoing</td>
                                                                <td>Reduce sugar intake and processed foods</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Vitamin D3</td>
                                                                <td>1 Capsule</td>
                                                                ...
                                                                <td>6 Weeks</td>
                                                                <td>Revisit after 3 weeks for HbA1c and BP check</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                            ...
                                            <div class="text-end pt-3 border-top">
                                                ...
                                                <img src="assets/img/signature.png" alt="Signature" height="40">
                                                <p class="mb-0"><small class="text-muted">Dr. Nikhil Mehra</small></p>
                                            </div>
                                        </div>
                            ...
                            <div class="accordion-item mt-3">
                                ...
                                <div id="flush-collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">
                                        ...
                                        <div class="border rounded-4 p-4 shadow bg-white">
                                            <!-- Condition Summary -->
                                            <h5 class="fw-semibold text-primary mb-3">Patient Diagnosis</h5>
                                            <p class="mb-3"><strong>Condition:</strong> Type 2 Diabetes Mellitus with Mild Hypertension</p>

                                            <!-- Phase-wise Treatment Plan -->
                                            <h6 class="fw-semibold text-dark border-bottom pb-2">Phase-wise Plan</h6>
                                            <ul class="mb-4">
                                                <li><strong>Phase 1 (Weeks 1–2):</strong> Stabilize blood glucose with Metformin 500mg, initiate BP monitoring, and begin dietary modifications.</li>
                                                <li><strong>Phase 2 (Weeks 3–4):</strong> Review lab reports (HbA1c, Fasting Sugar, Lipid Profile), continue medication, and introduce 30-minute morning walks.</li>
                                                <li><strong>Phase 3 (Week 5 onward):</strong> Evaluate response, adjust medication if needed, and reinforce long-term lifestyle changes.</li>
                                            </ul>

                                            <!-- Medicines -->
                                            <h6 class="fw-semibold text-dark border-bottom pb-2">Medications</h6>
                                            <ul class="mb-4">
                                                <li><strong>Metformin 500mg</strong> – 1 tab after breakfast and dinner</li>
                                                <li><strong>Amlodipine 5mg</strong> – 1 tab every morning</li>
                                                <li><strong>Vitamin D3 (Cholecalciferol)</strong> – 1 capsule once a week (Sunday)</li>
                                            </ul>

                                            <!-- Lifestyle Instructions -->
                                            <h6 class="fw-semibold text-dark border-bottom pb-2">Lifestyle & Diet Recommendations</h6>
                                            <ul class="mb-4">
                                                <li>Low-sugar, low-carb balanced meals</li>
                                                <li>Daily brisk walk or yoga (30–45 mins)</li>
                                                <li>Regular hydration – 2.5 to 3 litres/day</li>
                                                <li>Avoid fried foods and sugary drinks</li>
                                            </ul>

                                            <!-- Follow-Up Plan -->
                                            <h6 class="fw-semibold text-dark border-bottom pb-2">Follow-Up Schedule</h6>
                                            <p class="mb-1"><strong>Next Review:</strong> 15 August 2025</p>
                                            <p class="mb-1"><strong>Tests to Bring:</strong> HbA1c, FBS/PPBS, BP log chart (morning/evening)</p>
                                        </div>
                                ...
                                <div id="flush-collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">
                                        <div class="border rounded-4 p-4 shadow-sm bg-white">
                                            <h5 class="fw-semibold text-primary mb-3">Prescribed Medicines</h5>

                                            <div class="table-responsive">
                                                <table class="table table-bordered table-striped align-middle text-dark mb-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>After Breakfast & Dinner</td>
                                                            <td>30 Days</td>
                                                            <td>Take with food to avoid acidity</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td><strong>Vitamin D3 60,000 IU</strong></td>
                                                            <td>1 Capsule</td>
                                                            <td>Once a Week (Sunday)</td>
                                                            <td>8 Weeks</td>
                                                            <td>Take with milk or fatty food</td>
                                                        </tr>
                                                        <tr>
                            ...
                            <div class="accordion-item mt-3">
                                ...
                                <div id="flush-collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">
                                        <!-- Lab Tests Table -->
                                        <div class="border rounded-4 p-4 shadow-sm bg-white">
                                            <h5 class="fw-semibold text-primary mb-3">Recommended Tests</h5>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-striped align-middle text-dark mb-0">
                                                    ...
                                                    <tbody class="text-center">
                                                        ...
                                                        <tr>
                                                            <td><strong>Liver Function Test (LFT)</strong></td>
                                                            <td>27 July 2025</td>
                                                            <td><span class="badge bg-primary-subtle text-primary">Not Scheduled</span></td>
                                                            <td>
                                                                <a href="" class="btn btn-sm btn-outline-primary" download>
                                                                    <i class="ti ti-download me-1"></i>Download
                                                                </a>
                                                            ...
                                                            <ul class="mb-3">
                                                                <li class="mb-1">
                                                                    <label class="dropdown-item px-2 d-flex align-items-center text-dark">
                                                                        ...
                                                                        <span class="avatar avatar-xs rounded-circle me-2"><img src="assets/img/profiles/avatar-01.jpg" class="flex-shrink-0 rounded-circle" alt="img"></span>Dr. Mick Thompson
                                                                    </label>
                                                                </li>
                                                                <li class="mb-1">
                                                                    <label class="dropdown-item px-2 d-flex align-items-center text-dark">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <h6 class="fs-14 mb-1 text-truncate"><a href="" class="fw-semibold">Dr. Mick Thompson</a></h6>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <h6 class="fs-14 mb-1 text-truncate"><a href="" class="fw-semibold">Dr. Sarah Johnson</a></h6>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <h6 class="fs-14 mb-1 text-truncate"><a href="" class="fw-semibold">Dr. Emily Carter</a></h6>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <h6 class="fs-14 mb-1 text-truncate"><a href="" class="fw-semibold">Dr. David Lee</a></h6>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <h6 class="fs-14 mb-1 text-truncate"><a href="" class="fw-semibold">Dr. Anna Kim</a></h6>
...
<!-- Prescription image view Modal -->
<!-- Image View Modal for A4 Document -->
<div class="modal fade" id="imageModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content bg-white border-0 border-4 border-top border-info rounded-4 shadow">

            <!-- Close Button -->
            <div class="modal-header border-0 px-3 bg-info-subtle">
                <h4 class="modal-title text-dark fw-bold " id="staticBackdropLabel">Prescription Pdf</h4>
                <button type="button" class="btn-close ms-auto rounded-circle bg-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <!-- A4 Image Body -->
            <div class="modal-body d-flex justify-content-center p-3">
                <div class="bg-light shadow-sm rounded" style="width: 100%; max-width: 794px; aspect-ratio: 1 / 1.41;">
                    <img src="assets/img/users/pres1.jpg"
                        id="modalFullImage"
