...
<head>
    ...
    <!-- Theme Config Js -->
    <script src="assets/js/theme-script.js" type="0ea854bda0b6efc57c08769f-text/javascript"></script>
...
<body>
    ...
    <!-- jQuery -->
    <script src="assets/js/jquery-3.7.1.min.js" type="0ea854bda0b6efc57c08769f-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="assets/js/bootstrap.bundle.min.js" type="0ea854bda0b6efc57c08769f-text/javascript"></script>

    <!-- Simplebar JS -->
    <script src="assets/plugins/simplebar/simplebar.min.js" type="0ea854bda0b6efc57c08769f-text/javascript"></script>

    <!-- Select2 JS -->
    <script src="assets/plugins/select2/js/select2.min.js" type="0ea854bda0b6efc57c08769f-text/javascript"></script>

    <!-- Daterangepikcer JS -->
    <script src="assets/js/moment.min.js" type="0ea854bda0b6efc57c08769f-text/javascript"></script>
    <script src="assets/plugins/daterangepicker/daterangepicker.js" type="0ea854bda0b6efc57c08769f-text/javascript"></script>

    <!-- Date Time Pikcer JS -->
    <script src="assets/js/bootstrap-datetimepicker.min.js" type="0ea854bda0b6efc57c08769f-text/javascript"></script>

    <!-- Main JS -->
    <script src="assets/js/script.js" type="0ea854bda0b6efc57c08769f-text/javascript"></script>
